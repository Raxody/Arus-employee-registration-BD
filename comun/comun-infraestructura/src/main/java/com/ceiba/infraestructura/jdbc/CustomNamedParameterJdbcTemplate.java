...
public class CustomNamedParameterJdbcTemplate {
	...
	public Long crear(Object object,String sql) {
		...
		this.namedParameterJdbcTemplate.update(sql, paramSource,keyHolder,new String[] { "numerodocumento" });
		return keyHolder.getKey().longValue();
	}

	public Long crear(MapSqlParameterSource sqlParameterSource,String sql) {
		KeyHolder keyHolder = new GeneratedKeyHolder();
		this.namedParameterJdbcTemplate.update(sql, sqlParameterSource,keyHolder,new String[] { "numerodocumento" });
		return keyHolder.getKey().longValue();
	}
